...
function extractApenadoData(html: string) {
  ...
  return {
    ...
    sexo: extractSelect('sexo'),
    etnia: extractSelect('fk_etnia'),
    orientacaoSexual: extractSelect('homosexual'),
    tipoSanguineo: extractSelect('tiposanguineo'),
    grauInstrucao: extractSelect('fk_grauinstrucao'),
    religiao: extractSelect('fk_religiao'),
    estadoCivil: extractSelect('fk_estadocivil'),
    ...
    situacao: extractSelect('situacao'),
    ...
    presoOriundo: extractSelect('presooriundo'),
